...
class RegressionAnalysis():
    ...
    def get_quandl_data(quandl_data_set_name, quandl_settings):
        ...
        """
        quandl_data_set = quandl.get(quandl_data_set_name, rows=quandl_settings.rows, returns="numpy",
                              transformation=quandl_settings.transformation, api_key="gdJ1vymGy_fvmRYqJRSG",
